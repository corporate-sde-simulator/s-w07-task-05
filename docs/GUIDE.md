...
> **Welcome to Service-Track Week 7, Task 5!**
...
| `src/accessPatternTracker.ts` | Main source code - **has bugs to fix** |
| `src/warmupScheduler.ts` | Supporting code - **may also have bugs** |
| `tests/cacheWarmer.test.js` | Test file - **add your tests here** |
